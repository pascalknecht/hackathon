    ...
    <Box as="footer" bg="gray.800" aria-labelledby="footerHeading">
      ...
      <Box maxW="7xl" mx="auto" py={{ base: 12, lg: 16 }} px={[4, 6, null, 8]}>
        ...
        >
          ...
          >
            <GridColumn links={primaryLinks} title="Legal" />

            <GridColumn links={secondaryLinks} title="Secondary" />
          </Grid>
        ...
        >
          <Stack direction="row" display="flex" spacing={6} order={{ md: 2 }}>
            <SocialMediaLink title="LinkedIn" icon={LinkedInIcon} href="" />
            <SocialMediaLink title="Slack" icon={SlackIcon} href="" />
            <SocialMediaLink title="Twitter" icon={TwitterIcon} href="" />
            <SocialMediaLink title="GitHub" icon={GithubIcon} href="" />
          </Stack>
          ...
          <Text
            ...
            order={{ md: 1 }}
          >
            &copy; {new Date().getFullYear()} billable.io All rights reserved.
          </Text>
        </Box>
      </Box>
    </Box>

            ...
            <Box pt={5} pb={6} px={5}>
              <Flex alignItems="center" justifyContent="space-between">
                <div>
                  <Link href="/">
                    <a>
                      <VisuallyHidden>frequi</VisuallyHidden>
                      ...
                      return (
                        ...
                        >
                          <ChakraLink
                            ...
                            alignItems="center"
                            borderRadius="md"
                            color={isActive ? "indigo.600" : "gray.900"}
                            _hover={{
                              bg: "gray.50",
                            }}
                            key={"ld_" + page.id}
      ...
      <Box maxW="7xl" mx="auto" px={[4, 6]}>
        ...
        >
          <Flex w={{ lg: 0 }} flex={{ lg: "1 1 0" }}>
            <Link href="/">
              <a>
                <VisuallyHidden>freqie</VisuallyHidden>
          ...
          {pages && pages.length && (
            ...
            >
              {pages.map((page) => {
                ...
                return (
                  <Link key={"lml_" + page.id} href={`${page.slug}`} passHref>
                    <ChakraLink
                      fontSize="md"
                      fontWeight="medium"
              ...
              <Link href={`/login`} passHref>
                <ChakraLink>
                  <Button as="span" colorScheme="indigo">
                    Login
                  </Button>
                </ChakraLink>
              </Link>
